    ...
    <div v-if="fatherComponent == 'item'">
      <div class="item_back item_container_style">
        <div class="item_list_container" v-if="itemDetail.length > 0">
          <header class="item_title">{{itemDetail[itemNum-1].topic_name}} : {{itemDetail[itemNum-1].active_title}}</header>
          <ul>
      ...
      <span class="last_item button_style" @click="lastItem"></span>
      <template v-if="itemNum < itemDetail.length">
